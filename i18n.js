const TRANSLATIONS = {
  en: {
    ...
    'qr.desc': 'Create fully customizable QR codes with logo insertion, custom colors, gradient styles, and variable dot shapes. Perfect for links, Wi-Fi access, contact cards, and text — processed entirely locally on your device with zero data tracking.',
  ...
  vi: {
    ...
    'qr.desc': 'Tạo mã QR có thể tùy chỉnh hoàn toàn với logo, màu sắc tùy chọn, kiểu màu gradient và hình dáng điểm quét đa dạng. Hoàn hảo cho liên kết, Wi-Fi, danh thiếp và văn bản — tất cả được xử lý cục bộ trên thiết bị của bạn, bảo mật tuyệt đối.',
