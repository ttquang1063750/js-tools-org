const TRANSLATIONS = {
  en: {
    ...
    'rmbg.desc': 'Erase backgrounds from your photos instantly using local AI neural networks. Supports JPEG, PNG, WebP, and HEIC. The entire process runs 100% locally in your browser sandbox with zero server uploads, keeping your data secure.',
    ...
    'cq.desc': 'ColorQuarium turns your screen into a calming, generative art display — and your phone into a remote control. Open the live view on a TV or monitor, then use your phone to change colors, themes, and motion in real time.',
    ...
    'cq.demo.desc': 'This is a real, live ColorQuarium display. Scan the QR code with your phone to open the remote control and change what appears on screen in real time.',
  ...
  vi: {
    ...
    'rmbg.desc': 'Xóa phông nền hình ảnh của bạn ngay lập tức bằng mạng nơ-ron AI cục bộ. Hỗ trợ JPEG, PNG, WebP và HEIC. Toàn bộ quy trình diễn ra 100% trên thiết bị của bạn, bảo mật dữ liệu tuyệt đối.',
    ...
    'cq.desc': 'ColorQuarium biến màn hình của bạn thành một màn hình nghệ thuật sinh động, thư giãn — và biến điện thoại của bạn thành remote điều khiển. Mở màn hình hiển thị trên TV hoặc monitor, sau đó dùng điện thoại để thay đổi màu sắc, chủ đề và chuyển động theo thời gian thực.',
    ...
    'cq.demo.desc': 'Đây là một màn hình ColorQuarium thật, đang chạy trực tiếp. Quét mã QR bằng điện thoại để mở remote điều khiển và thay đổi nội dung hiển thị theo thời gian thực.',
