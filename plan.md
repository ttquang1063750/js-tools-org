...
| Series 20                                       | Thiết Kế Hệ Thống                       | 8/18           | 18       | 44%         |
...
- [~] **18 trang bài học (8/18):** Bài 1 ✅ · Bài 2 ✅ · Bài 3 ✅ · Bài 4 ✅ · Bài 5 ✅ · Bài 6 ✅ · Bài 7 ✅ · Bài 8 ✅ — viết theo đúng đề cương H2 ở Phần III, KHÔNG quiz, cấu trúc `.code-tabs`, đủ hình bắt buộc, đủ lab, references chuẩn, related links, giscus.
- [x] **Tích hợp toàn cục (kiểm cả HAI file index):**
  ...
  - [~] `sitemap.xml`: 18 bài + 1 hub + 1 sandbox — cập nhật dần theo từng bài (đã có hub + sandbox + Bài 1–8).
  - [~] `blog/search-index.json`: 18 entry — cập nhật dần theo từng bài (đã có Bài 1–8), `headingsVi` khớp H2 thực tế.
