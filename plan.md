...
| Series 20                                       | Thiết Kế Hệ Thống                       | 11/18          | 18       | 61%         |
...
- [~] **18 trang bài học (11/18):** Bài 1 ✅ · Bài 2 ✅ · Bài 3 ✅ · Bài 4 ✅ · Bài 5 ✅ · Bài 6 ✅ · Bài 7 ✅ · Bài 8 ✅ · Bài 9 ✅ · Bài 10 ✅ · Bài 11 ✅ — viết theo đúng đề cương H2 ở Phần III, KHÔNG quiz, cấu trúc `.code-tabs`, đủ hình bắt buộc, đủ lab, references chuẩn, related links, giscus.
- [x] **Tích hợp toàn cục (kiểm cả HAI file index):**
  ...
  - [~] `sitemap.xml`: 18 bài + 1 hub + 1 sandbox — cập nhật dần theo từng bài (đã có hub + sandbox + Bài 1–11).
  - [~] `blog/search-index.json`: 18 entry — cập nhật dần theo từng bài (đã có Bài 1–11), `headingsVi` khớp H2 thực tế.
