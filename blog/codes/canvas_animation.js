...
class Ball {
    ...
    update(dt) {
        ...
        if (this.y - this.r < 60) { this.y = 60 + this.r; this.vy *= -1; }
        if (this.y + this.r > 320) { this.y = 320 - this.r; this.vy *= -1; }
    }
...
const sprites = [
    new SpriteAnim(50, 360),
    new SpriteAnim(300, 380),
    new SpriteAnim(550, 350),
];
// Tốc độ khác nhau
sprites[1].speed = 120;
sprites[2].speed = 60;
