...
const longText =
  'Canvas cho phép bạn vẽ văn bản với nhiều tùy chỉnh. Tuy nhiên nó không tự động xuống dòng nên ta cần viết hàm word wrap để chia văn bản dài thành nhiều dòng phù hợp với chiều rộng cho phép.';
// Vẽ khung
