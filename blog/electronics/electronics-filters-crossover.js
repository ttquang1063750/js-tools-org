document.addEventListener('DOMContentLoaded', () => {
  ...
  function updateSVG() {
    ...
    if (mode === 'lowpass') {
      ...
      html +=
        '<text x="200" y="44" fill="#89b4fa" font-size="10" text-anchor="middle" font-weight="bold">Treble</text>';
      ...
      html +=
        '<path d="M 100 110 Q 105 100, 110 110 Q 115 100, 120 110 Q 125 100, 130 110 Q 135 100, 140 110" fill="none" stroke="#f9e2af" stroke-width="2" />';
