  ...
  function updateTruthTable() {
    ...
    if (mode === 'dff') {
      ...
      const states = [
        ...
        { wl: '1 (Mở)', mode: 'Ghi', bl: '0', blb: '1', q: '0', active: (sramWl === 1 && sramMode === 'write' && sramBl === 0) },
        { wl: '1 (Mở)', mode: 'Ghi', bl: '1', blb: '0', q: '1', active: (sramWl === 1 && sramMode === 'write' && sramBl === 1) },
        { wl: '1 (Mở)', mode: 'Đọc', bl: 'Q (Đọc)', blb: '/Q', q: String(sramQ), active: (sramWl === 1 && sramMode === 'read') }
      ];
