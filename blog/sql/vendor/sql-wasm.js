...
var initSqlJs = function (moduleConfig) {
  ...
  initSqlJsPromise = new Promise(function (resolveModule, reject) {
          ...
          O.Wa ||
            (O.Wa = {
              ...
              file: {
                ...
                stream: { Va: O.Ma.Va, read: O.Ma.read, write: O.Ma.write, ib: O.Ma.ib, jb: O.Ma.jb },
              },
    ...
    function oa(a, b, c = 438) {
      ...
      if (
        !h &&
        (e = d ? (40960 === (d.mode & 61440) ? 32 : P(d.mode) && ('r' !== Pb(b) || b & 576) ? 31 : Ob(d, Pb(b))) : 44)
      )
        throw new N(e);
      b & 512 && !h && ((e = d), (e = 'string' == typeof e ? S(e, { $a: !0 }).node : e), cc(null, e, 0));
      b &= -131713;
      e = Tb({ node: d, path: ja(d), flags: b, seekable: !0, position: 0, Ma: d.Ma, Lb: [], error: !1 });
    ...
    var Xc = {
        a: (a, b, c, d) =>
          Ta(
            `Assertion failed: ${a ? B(x, a) : ''}, at: ` +
              [b ? (b ? B(x, b) : '') : 'unknown filename', c, d ? (d ? B(x, d) : '') : 'unknown function']
          ),
        i: function (a, b) {
          try {
        ...
        A: function (a, b) {
          ...
          var c = a.getFullYear();
          E[(b + 28) >> 2] =
            ((0 !== c % 4 || (0 === c % 100 && 0 !== c % 400) ? Mc : Lc)[a.getMonth()] + a.getDate() - 1) | 0;
