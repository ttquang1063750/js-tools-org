  ...
  return (function () {
    ...
    var Wt = function (e, t) {
        ...
        if (n.isStretchy)
          ...
          ('\\vec' === n.label
            ...
            : (((u = ee((u = Ke.makeOrd({ mode: n.mode, text: n.label }, t, 'textord')))).italic = 0),
              (p = u.width),
              c && (m += u.depth)),
    ...
    ot({
      ...
      htmlBuilder: function (e, t) {
        ...
        (i.classes.push(o + '-arrow-pad'),
          e.below &&
            ((a = t.havingStyle(n.sub())), (r = Ke.wrapFragment(wt(e.below, a, t), t)).classes.push(o + '-arrow-pad')));
        var s,
          l = Gt(e, t),
    ...
    var ir = {
      ...
      sr = function (e, t, r, n) {
        ...
        (null == a &&
          ((r.noexpand = !0), (a = { tokens: [r], numArgs: 0, unexpandable: !e.gullet.isExpandable(r.text) })),
        ...
        sqrtImage: function (e, t) {
          ...
          return (
            'small' === i.type
              ? (e < 1 ? (o = 1) : e < 1.4 && (o = 0.7),
                (h = (1 + s) / o),
                ((r = yr('sqrtMain', (l = (1 + s + br) / o), (c = 1e3 + 1e3 * s + 80), s, t)).style.minWidth =
                  '0.853em'),
                (n = 0.833 / o))
              : 'large' === i.type
                ? ((c = 1080 * Sr[i.size]),
    ...
    var jr = function (e, t) {
        ...
        for (a = 0, N = 0; a < s || N < I.length; ++a, ++N) {
          for (var V = I[N] || {}, G = !0; 'separator' === V.type; ) {
            if (
              (G ||
                (((C = Ke.makeSpan(['arraycolsep'], [])).style.width = F(t.fontMetrics().doubleRuleSep)), R.push(C)),
          ...
          return (
            ...
            (function (e) {
              ...
              for (var a, i, o = [], s = [o], l = 0; l < t.length; l++) {
                for (
                  var h = t[l], c = { type: 'styling', body: [], mode: 'math', style: 'display' }, m = 0;
                  m < h.length;
                  m++
                )
                  if (tr(h[m])) {
      ...
      nn = function (e, t) {
        ...
        if (
          ...
          n.size === x.DISPLAY.size || 'display' === e.size
            ...
            : (c > 0 ? ((u = t.fontMetrics().num2), (p = m)) : ((u = t.fontMetrics().num3), (p = 3 * m)),
    ...
    var ln = function (e, t) {
      var r,
        ...
        a = t.style;
      'supsub' === e.type
        ? ((r = e.sup ? wt(e.sup, t.havingStyle(a.sup()), t) : wt(e.sub, t.havingStyle(a.sub()), t)),
    ...
    (ot({
      ...
      mathmlBuilder: function (e, t) {
        ...
        var n = P(e.height, t),
          a = 0;
        if (
          (e.totalheight.number > 0 && ((a = P(e.totalheight, t) - n), r.setAttribute('valign', F(-a))),
    ...
    (ot({
      ...
      ot({
        ...
        htmlBuilder: function (e, t) {
          ...
          return (
            (r = Ke.makeVList({ positionType: 'firstBaseline', children: [{ type: 'elem', elem: r }] }, t)),
      ...
      ot({
        ...
        mathmlBuilder: function (e, t) {
          ...
          return (
            a >= 0 ? s.setAttribute('height', F(a)) : (s.setAttribute('height', F(a)), s.setAttribute('depth', F(-a))),
      ...
      htmlBuilder: function (e, t) {
        ...
        if (n && a) {
          ...
          ((u = Math.max(u, i, n.depth + 0.25 * m.xHeight)),
            (v = Ke.makeVList(
              { positionType: 'shift', positionData: -u, children: [{ type: 'elem', elem: n, marginRight: y }] },
              t
            )));
        }
        ...
        return (
          ...
          (t.handleInfixNodes = function (e) {
            ...
            if (-1 !== r && t) {
              ...
              return (
                (i =
                  1 === s.length && 'ordgroup' === s[0].type ? s[0] : { type: 'ordgroup', mode: this.mode, body: s }),
                (o =
                  1 === l.length && 'ordgroup' === l[0].type ? l[0] : { type: 'ordgroup', mode: this.mode, body: l }),
          ...
          (t.formLigatures = function (e) {
            for (var t = e.length - 1, r = 0; r < t; ++r) {
              ...
              ('-' === a &&
                '-' === e[r + 1].text &&
                (r + 1 < t && '-' === e[r + 2].text
                  ? (e.splice(r, 3, { type: 'textord', mode: 'text', loc: Fr.range(n, e[r + 2]), text: '---' }),
                    (t -= 2))
                  : (e.splice(r, 2, { type: 'textord', mode: 'text', loc: Fr.range(n, e[r + 1]), text: '--' }),
                    (t -= 1))),
                ("'" !== a && '`' !== a) ||
                  e[r + 1].text !== a ||
                  (e.splice(r, 2, { type: 'textord', mode: 'text', loc: Fr.range(n, e[r + 1]), text: a + a }),
                  (t -= 1)));
            }
          }),
          (t.parseSymbol = function () {
            ...
            var i,
              o = On.exec(t);
            if (
              (o && ('i' === (t = t.substring(0, o.index)) ? (t = '\u0131') : 'j' === t && (t = '\u0237')),
              ae[this.mode][t])
            ) {
              this.settings.strict &&
                'math' === this.mode &&
